...
function Library:Create(name,subname,keybind)
	...
	Main.Name = "Main"
	Main.Parent = xz
	Main.BackgroundColor3 = shit.accent
...
PageHolder.BackgroundColor3 = shit.accent
PageHolder.BorderSizePixel = 0
PageHolder.Position = UDim2.new(0, 193, 0, 7)
PageHolder.Size = UDim2.new(0, 445, 0, 352)
...
TabSeparator.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
TabSeparator.BorderSizePixel = 0
TabSeparator.Position = UDim2.new(0, 190, 0, 52)
TabSeparator.Size = UDim2.new(0, 2, 0, 300)
...
local CurrentKeybind = keybind or shit.togglebind
...
function Window:SetAccent(color)
	...
	-- Main window / title area
	Main.BackgroundColor3 = shit.accent

	-- Main content background follows the theme
PageHolder.BackgroundColor3 = shit.accent

for _, obj in ipairs(PageHolder:GetChildren()) do
	if obj:IsA("Frame") then
		obj.BackgroundColor3 = shit.accent
	end
end

	-- Tabs
	for _, obj in ipairs(TabsHolder:GetChildren()) do
		if obj:IsA("TextButton") and obj.Name == "Tab" then
			if obj.TextTransparency == 0 then
				obj.BackgroundColor3 = shit.accent
			else
				obj.BackgroundColor3 = Color3.fromRGB(22, 22, 22)
			end
		end
	end

	-- Toggle indicators
	for _, obj in ipairs(xz:GetDescendants()) do
		if obj:IsA("ImageLabel") and obj.Name == "Toggle" then
			obj.BackgroundColor3 = shit.accent
		end
	end
end
	...
	Tab.BackgroundColor3 = shit.accent
	...
	Page.BackgroundColor3 = shit.accent
	Page.BorderSizePixel = 0
	Page.Size = UDim2.new(0, 445, 0, 352)
	...
	PageContainer.Position = UDim2.new(0, 6, 0, 7)
	PageContainer.Size = UDim2.new(0, 433, 0, 338)
...
UIListLayout.Padding = UDim.new(0, 8)
	...
	for _, z in pairs(TabsHolder:GetChildren()) do
		if z:IsA("TextButton") then
			...
			z.BackgroundColor3 = Color3.fromRGB(22, 22, 22)
		end
	end
	...
	Button_2.Position = UDim2.new(0.014, 0, 0, 0)
	Button_2.Size = UDim2.new(0, 423, 0, 32)
	Button_2.Font = Enum.Font.Gotham
	Button_2.Text = tostring(text)
	...
	function ButtonAPI:SetText(newText)
		Button_2.Text = tostring(newText)
	end
